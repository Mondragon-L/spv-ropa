...
import mx.venado.pvr.controlador.PvrConfiguracion;

public class DfrmNucleo extends javax.swing.JDialog {

    PvrConfiguracion pvrConfiguracion;

    public DfrmNucleo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        configForm();
    }
    ...
    private void configForm() {
        pvrConfiguracion = new PvrConfiguracion(this);
    }
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("Bd"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DfrmNucleo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DfrmNucleo dialog = new DfrmNucleo(new javax.swing.JFrame(), true);
    ...
    public javax.swing.JTable getTblBd() {
        return tblBd;
    }

    public javax.swing.JTable getTblSistema() {
        return tblSistema;
    }
}
